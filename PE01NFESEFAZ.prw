...
User Function PE01NFESEFAZ()
	...
	If lNFSaida //Regras para as notas de saida
		...
		If FindFunction("faturamento.nf.dadosComplementares.u_quartaNota")
			aRetorno[2]	:= aRetorno[2] + "  " + aRetorno[3] + ' ' + faturamento.nf.dadosComplementares.u_quartaNota(aRetorno[1])
		EndIf
		...
		If FindFunction("faturamento.nf.dadosComplementares.u_icmsDiferido")
			aRetorno[2] := faturamento.nf.dadosComplementares.u_icmsDiferido() + aRetorno[2]
		EndIf
