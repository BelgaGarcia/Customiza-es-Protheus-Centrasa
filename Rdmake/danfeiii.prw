...
#DEFINE MAXITEMC  012 + 048                                          // Máxima de caracteres por linha de produtos/serviços
#DEFINE MAXMENLIN 130 + 030                                          // Máximo de caracteres por linha de dados adicionais
...
//	nPerDesc	:= ((nDesc*100)/nVTotal)
	...
	AADD(aAux, AllTrim(TransForm(nVUniLiq,TM(nVUniLiq,TamSX3("D2_PRCVEN")[1],2))))
...
oDanfe:Say(nLine+215 - nAjustaDest,nBaseTxt,NoChar(oDestino:_XNome:TEXT,lConverte),oFont09:oFont)
...
oDanfe:Say(nLine+215 - nAjustaDest,552,cAux,oFont09:oFont)
...
oDanfe:Say(nLine+240 - nAjustaDest,nBaseTxt,aDest[01],oFont09:oFont)
...
oDanfe:Say(nLine+240 - nAjustaDest,412,aDest[02],oFont09:oFont)
oDanfe:Box(nLine+222 - nAjustaDest,602,nLine+247,MAXBOXH-40)
oDanfe:Say(nLine+230 - nAjustaDest,612,"CEP",oFont08N:oFont)
oDanfe:Say(nLine+240 - nAjustaDest,612,aDest[03],oFont09:oFont)
...
oDanfe:Say(nLine+265 - nAjustaDest,nBaseTxt,aDest[05],oFont09:oFont)
...
oDanfe:Say(nLine+265 - nAjustaDest,312,aDest[06],oFont09:oFont)
oDanfe:Box(nLine+247 - nAjustaDest,502,nLine+270 - nAjustaDest,542)
oDanfe:Say(nLine+255 - nAjustaDest,512,"UF",oFont08N:oFont)
oDanfe:Say(nLine+265 - nAjustaDest,512,aDest[07],oFont09:oFont)
...
oDanfe:Say(nLine+265 - nAjustaDest,552,aDest[08],oFont09:oFont)
...
//oDanfe:Say(nLine+215 - nAjustaDest,MAXBOXH-30,Iif(oNF:_INFNFE:_VERSAO:TEXT >= "3.10",ConvDate(oIdent:_DHEmi:TEXT),ConvDate(oIdent:_DEmi:TEXT)),oFont09:oFont)
oDanfe:SayAlign(nLine+210 - nAjustaDest,MAXBOXH-5,Iif(oNF:_INFNFE:_VERSAO:TEXT >= "3.10",ConvDate(oIdent:_DHEmi:TEXT),ConvDate(oIdent:_DEmi:TEXT)),oFont09:oFont, 40, , , 2)
...
//oDanfe:Say(nLine+240 - nAjustaDest,MAXBOXH-30,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont09:oFont)
oDanfe:SayAlign(nLine+235 - nAjustaDest,MAXBOXH-5,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont09:oFont, 40, , , 2)
...
//oDanfe:Say(nLine+265 - nAjustaDest,MAXBOXH-30,aHrEnt[01],oFont09:oFont)
oDanfe:SayAlign(nLine+260 - nAjustaDest,MAXBOXH-5,aHrEnt[01],oFont09:oFont, 40, , , 2)
...
oDanfe:Say(nLine+305+nAjustaFat,nBaseTxt+7,"FAT",oFont08N:oFont, ,CLR_WHITE , 270 ) 
nBaseTxt += 30 
...
oDanfe:SayAlign(nLine+057,nBaseTxt, "Identificação do emitente",oFont12N:oFont, 250, , , 2)
If len(oEmitente:_xNome:Text)>43
	oDanfe:SayAlign(nLine+070,nBaseTxt,SubStr(NoChar(oEmitente:_xNome:Text,lConverte),1,45), ValidDanfe(oDanfe:nDevice), 250, , , 2)
	oDanfe:SayAlign(nLine+080,nBaseTxt,SubStr(NoChar(oEmitente:_xNome:Text,lConverte),46,45), ValidDanfe(oDanfe:nDevice), 250, , , 2)
Else
	oDanfe:SayAlign(nLine+070,nBaseTxt, NoChar(oEmitente:_xNome:Text,lConverte),ValidDanfe(oDanfe:nDevice), 250, , , 2)
Endif
If len(oEmitente:_xNome:Text)>45
	oDanfe:SayAlign(nLine+090,nBaseTxt, NoChar(oEmitente:_EnderEmit:_xLgr:Text,lConverte)+", "+oEmitente:_EnderEmit:_Nro:Text,oFont08N:oFont, 250, , , 2)
Else
	oDanfe:SayAlign(nLine+080,nBaseTxt, NoChar(oEmitente:_EnderEmit:_xLgr:Text,lConverte)+", "+oEmitente:_EnderEmit:_Nro:Text,oFont08N:oFont, 250, , , 2)
Endif
If len(oEmitente:_xNome:Text)>45
	If Type("oEmitente:_EnderEmit:_xCpl") <> "U"
		oDanfe:SayAlign(nLine+100,nBaseTxt, "Complemento: " + NoChar(oEmitente:_EnderEmit:_xCpl:TEXT,lConverte),oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+110,nBaseTxt, NoChar(oEmitente:_EnderEmit:_xBairro:Text,lConverte)+" Cep:"+TransForm(IIF(Type("oEmitente:_EnderEmit:_Cep")=="U","",oEmitente:_EnderEmit:_Cep:Text),"@r 99999-999"),oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+120,nBaseTxt, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+130,nBaseTxt, "Fone: "+IIf(Type("oEmitente:_EnderEmit:_Fone")=="U","",oEmitente:_EnderEmit:_Fone:Text),oFont08N:oFont, 250, , , 2)
	Else
		oDanfe:SayAlign(nLine+100,nBaseTxt, NoChar(oEmitente:_EnderEmit:_xBairro:Text,lConverte)+" Cep:"+TransForm(IIF(Type("oEmitente:_EnderEmit:_Cep")=="U","",oEmitente:_EnderEmit:_Cep:Text),"@r 99999-999"),oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+110,nBaseTxt, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+120,nBaseTxt, "Fone: "+IIf(Type("oEmitente:_EnderEmit:_Fone")=="U","",oEmitente:_EnderEmit:_Fone:Text),oFont08N:oFont, 250, , , 2)
	EndIf
	
Else
	If Type("oEmitente:_EnderEmit:_xCpl") <> "U"
		oDanfe:SayAlign(nLine+090,nBaseTxt, "Complemento: " + NoChar(oEmitente:_EnderEmit:_xCpl:TEXT,lConverte),oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+100,nBaseTxt, NoChar(oEmitente:_EnderEmit:_xBairro:Text,lConverte)+" Cep:"+TransForm(IIF(Type("oEmitente:_EnderEmit:_Cep")=="U","",oEmitente:_EnderEmit:_Cep:Text),"@r 99999-999"),oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+110,nBaseTxt, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+120,nBaseTxt, "Fone: "+IIf(Type("oEmitente:_EnderEmit:_Fone")=="U","",oEmitente:_EnderEmit:_Fone:Text),oFont08N:oFont, 250, , , 2)
	Else
		oDanfe:SayAlign(nLine+090,nBaseTxt, NoChar(oEmitente:_EnderEmit:_xBairro:Text,lConverte)+" Cep:"+TransForm(IIF(Type("oEmitente:_EnderEmit:_Cep")=="U","",oEmitente:_EnderEmit:_Cep:Text),"@r 99999-999"),oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+100,nBaseTxt, oEmitente:_EnderEmit:_xMun:Text+"/"+oEmitente:_EnderEmit:_UF:Text,oFont08N:oFont, 250, , , 2)
		oDanfe:SayAlign(nLine+110,nBaseTxt, "Fone: "+IIf(Type("oEmitente:_EnderEmit:_Fone")=="U","",oEmitente:_EnderEmit:_Fone:Text),oFont08N:oFont, 250, , , 2)
	EndIf
Endif
...
oDanfe:Say(nLine+110,nBaseTxt,"N. "+StrZero(Val(oIdent:_NNf:Text),9),oFont12N:oFont)
oDanfe:Say(nLine+120,nBaseTxt,"SÉRIE "+SubStr(oIdent:_Serie:Text,1,3),oFont12N:oFont)
oDanfe:Say(nLine+130,nBaseTxt,"FOLHA "+StrZero(nFolha,2)+"/"+StrZero(nFolhas,2),oFont12N:oFont)
...
If nfolha>=1
	If lMv_Logod
		oDanfe:SayBitmap(005,075,cLogoD,120/*095*/,096)
	Else
		oDanfe:SayBitmap(005,075,cLogo,120/*095*/,096)
	EndIf
Endif
...
Static Function DanfeIT(oDanfe, nLine, nBaseCol, nBaseTxt, nFolha, nFolhas, aColProd, aMensagem, nPosMsg, aTamCol)
	...
	If nFolha == 1   
		...
		If nMAXITEM <> 0
			...
			For Nx :=1 to Len(aColProd)
				If !(Nx == 10 .Or. Nx == 11 .Or. Nx == 12 .Or. Nx == 14 .Or. Nx == 16)
					If ( valType(oEntrega)=="U" ) .and. ( valType(oRetirada)=="U")
	...
	Else
		...
		Else
			...
			oDanfe:Say(nLine+462, nAux + 2,"COD. PROD", oFont08N:oFont)
			nAux += aTamCol[1]
			oDanfe:Box(nLine+454, nAux, nLine+469, nAux + aTamCol[2] + aTamCol[10] + aTamCol[11] + aTamCol[12] + aTamCol[14] + aTamCol[16])
			oDanfe:Say(nLine+462, nAux + 2,"DESCR PROD", oFont08N:oFont)
			nAux += aTamCol[2] + aTamCol[10] + aTamCol[11] + aTamCol[12] + aTamCol[14] + aTamCol[16]
			oDanfe:Box(nLine+454, nAux, nLine+469, nAux + aTamCol[3])
			oDanfe:Say(nLine+462, nAux + 2,"NCM/SH", oFont08N:oFont)
			nAux += aTamCol[3]
			oDanfe:Box(nLine+454, nAux, nLine+469, nAux + aTamCol[4])
...
Static Function DanfeInfC(oDanfe,aMensagem,nBaseTxt,nBaseCol,nLine,nPosMsg, nFolha,lComplemento )
	...
	If nFolha == 1
		...
		oDanfe:FillRect({nLine+597+nAjustaDad-24,nBaseCol,MAXBOXV-1,nBaseCol+30},oBrush)
		oBrush:End()
		
		oDanfe:Say(MAXBOXV-25+12,nBaseTxt+1,"DADOS",oFont08N:oFont, , CLR_WHITE, 270 )
		oDanfe:Say(MAXBOXV-13+12,nBaseTxt+11,"ADICIONAIS"    ,oFont08N:oFont, ,CLR_WHITE , 270 )
		nBaseTxt += 30 
		
		oDanfe:Box(nLine+597+nAjustaDad-24,nBaseCol+30,MAXBOXV,622+110)
		oDanfe:Say(nLine+606+nAjustaDad-24,nBaseTxt,"INFORMAÇÕES COMPLEMENTARES",oFont08N:oFont)
		
		
		nLenMensagens:= Len(aMensagem)
		nLin:= nLine+618+nAjustaDad-24
		...
		oDanfe:Box(nLine+597+nAjustaDad-24,622+110,MAXBOXV,MAXBOXH+70)
		oDanfe:Say(nLine+606+nAjustaDad-24,632+110,"RESERVADO AO FISCO",oFont08N:oFont)
	...
	ElseIf nFolha >= 2
		...
		oDanfe:Box(nLine+397,nBaseCol+30,MAXBOXV,622+110)
		if lComplemento
			nBaseTxt += 30
		endif
		...
		oDanfe:Box(nLine+397,622+110,MAXBOXV,MAXBOXH+70)
		oDanfe:Say(nLine+406,632+110,"RESERVADO AO FISCO",oFont08N:oFont)
...
Static Function RetTamCol(aCabec, aValores, oPrinter, oFontCabec, oFont)
	...
	*/
		aTamCol := {45,; //1 COD. PROD
					69,; //2 DESCR PROD
					39,; //3 NCM/SH
					iif(aCabec[4] == "CSOSN", 22, 19),; //4  CST/CSON
					23,;//5 CFOP
					15,;//6 UN
					40,; //7 QUANT.
					45,; //8 V.UNITARIO
	...
	aTamCol[2]	+= aTamCol[10] + aTamCol[11] + aTamCol[12] + aTamCol[14] + aTamCol[16]
